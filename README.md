...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-iwkfx0s.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-iwkfx0s.containers.anotherwebservice.com/
...
```
git clone git@github.com:nischay876/container-iwkfx0s.git
cd container-iwkfx0s
```
...
```
docker attach container-iwkfx0s
```
